...
def Answer(question):
    ...
    chat_completion = client.chat.completions.create(
        messages=[
            {
                "role": "user",
                "content": f"Read very carefully, answer from this text: Student-- {combined_text} ,teacher-- {combined_teacher} and Marks-- {combined_marks}(The First data is having list of students having thier roll no and and teacher id, teacher is having thier name and id, marks is having marks id and marks value and student id). and only give the answer no other words, no explanations just answer. my question my question is :{question}",
            }
        ],
